...
drone.set_pitch(y) #往前移動的功率設為y，也就是30
drone.move(1) #無人機移動1秒
drone.set_pitch(0) #往前移動的功率設為0
drone.set_roll(x) #往右移動的功率設為x，也就是20
drone.move(1) #無人機移動1秒
drone.set_roll(0) #往右移動的功率設為0
drone.set_pitch(y) #往前移動的功率設為y，也就是30
drone.move(1) #無人機移動1秒
drone.set_pitch(0) #往前移動的功率設為0
drone.set_roll(-x) #往左移動的功率設為x，也就是20
drone.move(1) #無人機移動1秒
drone.set_roll(0) #往左移動的功率設為0
drone.set_pitch(y) #往前移動的功率設為y，也就是30
drone.move(1) #無人機移動1秒
drone.set_pitch(0) #往前移動的功率設為0
drone.set_roll(x) #往右移動的功率設為x，也就是20
