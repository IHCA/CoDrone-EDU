...
drone.set_throttle(30)  # 往前移動duration秒，也就是1秒
drone.move(2)  # 往上移動2秒
drone.hover(1)  # 在空中停留1秒

for x in range(0, 3, 1):  # 重複執行3次
    powerRand = randint(10, 20)  # powerRand會是10到30之間隨機的數字
    timeRand = randint(2, 3)  # timeRand會是1到3之間隨機的數字
    powerRand = powerRand * 1.5
